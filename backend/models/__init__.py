...
complete :class:`GameState` objects.  The models defined here are
deliberately minimal for the M0 milestone and may be extended in
future milestones to incorporate additional fields such as card
history, pot breakdown and showdown results.
"""
